...
// Bright cyan/purple reads well on the dark theme's near-black background but
// washes out on the light theme's white background, so swap to darker,
// higher-contrast stops once we know which theme is active.
...
export const BackgroundBeams = React.memo(
  ({ className, subtle = false }: Props) => {
    ...
    const [colorA, colorB, colorC] =
      mounted && resolvedTheme === "light" ? LIGHT_STOPS : DARK_STOPS;
          ...
          <defs>
            {indices.map((index) => (
              ...
              >
                ...
                <stop offset="10%" stopColor={colorB}></stop>
                <stop offset="16%" stopColor={colorC} stopOpacity="0"></stop>
                <stop offset="100%" stopColor={colorC} stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
